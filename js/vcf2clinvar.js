...
if (typeof module !== 'undefined') {
  ...
  var clinvar_fn = "oot.vcf";
  var inp_fn = "abe.vcf";

  var clinvar_lines = fs.readFileSync(clinvar_fn, {encoding:"utf8"}).split("\n");
  var genome_lines  = fs.readFileSync(inp_fn, {encoding:"utf8"}).split("\n");
}
...
if (typeof module !== 'undefined') {
  var res = clinvar_report(clinvar_lines, genome_lines);
